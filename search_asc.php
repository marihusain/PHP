                ...
                <div class="container-fluid outer">
                    ...
                    <div class="row-fluid">                   
                       ...
                       <table align="center">
						...
						<tr><td>Search ASC</td><td><input type="text" name="asc_code" placeholder="Enter ASC Code" /></td><td><input type="submit" name="search" value="search"/></td></tr>
...
$qry="select * from add_asc where asc_centre_code LIKE '%$asc_code%'"; 
